...
#define Sense_1_Pin GPIO_PIN_3
#define Sense_1_GPIO_Port GPIOA
#define Sense_2_Pin GPIO_PIN_4
...
#define Vswagelok_An_Pin GPIO_PIN_7
#define Vswagelok_An_GPIO_Port GPIOA
#define V3_An_Pin GPIO_PIN_0
#define V3_An_GPIO_Port GPIOB
#define Fire_1_Pin GPIO_PIN_1
#define Fire_1_GPIO_Port GPIOB
#define Fire_2_Pin GPIO_PIN_2
#define Fire_2_GPIO_Port GPIOB
#define Pyros_Arm_Pin GPIO_PIN_10
...
#define Servo2_Open_Pin GPIO_PIN_12
#define Servo2_Open_GPIO_Port GPIOA
