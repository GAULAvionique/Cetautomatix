...
/* Private defines -----------------------------------------------------------*/
#define ISO_CAN_OUT_Pin GPIO_PIN_13
#define ISO_CAN_OUT_GPIO_Port GPIOC
#define EXTEND_IO1_Pin GPIO_PIN_14
#define EXTEND_IO1_GPIO_Port GPIOC
#define EXTEND_IO2_Pin GPIO_PIN_15
...
#define V12_An_Pin GPIO_PIN_3
#define V12_An_GPIO_Port GPIOA
#define V5_An_Pin GPIO_PIN_4
#define V5_An_GPIO_Port GPIOA
#define V3_An_Pin GPIO_PIN_5
#define V3_An_GPIO_Port GPIOA
#define Vin_An_Pin GPIO_PIN_6
#define Vin_An_GPIO_Port GPIOA
#define Power_Good_Pin GPIO_PIN_7
#define Power_Good_GPIO_Port GPIOA
#define EXTEND_IO3_Pin GPIO_PIN_0
#define EXTEND_IO3_GPIO_Port GPIOB
#define EXTEND_IO4_Pin GPIO_PIN_1
#define EXTEND_IO4_GPIO_Port GPIOB
#define EXTEND_IO5_Pin GPIO_PIN_2
...
#define EXTEND_IO6_Pin GPIO_PIN_12
#define EXTEND_IO6_GPIO_Port GPIOB
#define EXTEND_IO7_Pin GPIO_PIN_13
#define EXTEND_IO7_GPIO_Port GPIOB
#define EXTEND_IO8_Pin GPIO_PIN_14
#define EXTEND_IO8_GPIO_Port GPIOB
#define EXTEND_IO9_Pin GPIO_PIN_15
#define EXTEND_IO9_GPIO_Port GPIOB
#define EXTEND_IO10_Pin GPIO_PIN_8
#define EXTEND_IO10_GPIO_Port GPIOA
#define EXTEND_IO11_Pin GPIO_PIN_9
#define EXTEND_IO11_GPIO_Port GPIOA
...
#define EXTEND_IO12_Pin GPIO_PIN_15
#define EXTEND_IO12_GPIO_Port GPIOA
#define SYS_SWO_Pin GPIO_PIN_3
#define SYS_SWO_GPIO_Port GPIOB
#define EXTEND_IO13_Pin GPIO_PIN_4
#define EXTEND_IO13_GPIO_Port GPIOB
#define EXTEND_IO14_Pin GPIO_PIN_5
#define EXTEND_IO14_GPIO_Port GPIOB
