...
#define EXTEND_IO1_Pin GPIO_PIN_0
#define EXTEND_IO1_GPIO_Port GPIOB
#define EXTEND_IO2_Pin GPIO_PIN_1
#define EXTEND_IO2_GPIO_Port GPIOB
#define EXTEND_IO3_Pin GPIO_PIN_2
...
#define EXTEND_IO7_Pin GPIO_PIN_15
#define EXTEND_IO7_GPIO_Port GPIOB
#define EXTEND_IO8_Pin GPIO_PIN_8
#define EXTEND_IO8_GPIO_Port GPIOA
#define EXTEND_IO9_Pin GPIO_PIN_9
#define EXTEND_IO9_GPIO_Port GPIOA
...
#define EXTEND_IO10_Pin GPIO_PIN_15
#define EXTEND_IO10_GPIO_Port GPIOA
#define SYS_SWO_Pin GPIO_PIN_3
#define SYS_SWO_GPIO_Port GPIOB
#define EXTEND_IO11_Pin GPIO_PIN_4
#define EXTEND_IO11_GPIO_Port GPIOB
#define EXTEND_IO12_Pin GPIO_PIN_5
#define EXTEND_IO12_GPIO_Port GPIOB
