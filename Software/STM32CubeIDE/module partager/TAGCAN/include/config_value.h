...
extern CAN_MODE ACTIF_CAN_MODE;/**< le mode CAN actuellement sellectionner. bien que sans la configuration, elle ne sert un peux pas à grand chause, il pert de généralisé du code entre 2 (ou plus) stm32 */
